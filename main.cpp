...
int main() {
    ...
    // Ventas Netas = Ventas Brutas - (Devoluciones + Bonificaciones + Descuentos)
    double totalVentasNetas{};

    double laptopsVendidas{}, smartphonesVendidos{}, tabletsVendidas{}, monitoresVendidos{}, combosVendidos{},
            discosVendidos{}, licenciasVendidas{};

    // Las ventas brutas indican el volumen general de la actividad comercial.
    // Solo incluye el valor de los productos, sin incluir descuentos ni IVA.
    double ventasBrutasLaptops{}, ventasBrutasSmartphones{}, ventasBrutasTablets{}, ventasBrutasMonitores{},
            ventasBrutasCombos{}, ventasBrutasDiscos{}, ventasBrutasLicencias{};

    double ivaLaptops{}, ivaSmartphones{}, ivaTablets{}, ivaMonitores{}, ivaCombos{}, ivaDiscos{}, ivaLicencias{};

    double descuentosLaptops{}, descuentosSmartphones{}, descuentosTablets{}, descuentosMonitores{},
            descuentosCombos{}, descuentosDiscos{}, descuentosLicencias{};

    double montoTotalLaptops{}, montoTotalSmartphones{}, montoTotalTablets{}, montoTotalMonitores{},
            montoTotalCombos{}, montoTotalDiscos{}, montoTotalLicencias{};
        ...
        if (opcionMenu == 'a') {
            while (seguirRegistrando == 's' || seguirRegistrando == 'S') {
                ...
                double subtotalLaptopsCliente{}, subtotalSmartphonesCliente{}, subtotalTabletsCliente{},
                        ...
                        subtotalLicenciasCliente{};

                double ivaLaptopsCliente{}, ivaSmartphonesCliente{}, ivaTabletsCliente{}, ivaMonitoresCliente{},
                        ivaCombosCliente{}, ivaDiscosCliente{}, ivaLicenciasCliente{};
                ...
                while (continuarComprando == 's' || continuarComprando == 'S') {
                    ...
                    while (!codigoValido) {
                        cout << cyan << bold << "► " << reset << "Ingrese el codigo del producto " << yellow <<
                                "(1-7): " <<
                                reset;
                        cin >> codigoProducto;
                        ...
                        if (cin.fail()) {
                            ...
                            cout << red << bold << "❌ Error: " << reset << italic << "Ingrese una opcion entre " <<
                                    yellow
                                    << "1 y 7." << reset << "\n" << endl;
                        }
                    }
                    ...
                    switch (codigoProducto) {
                        case 1:
                            ...
                            porcentajeIvaProducto = IVA_LAPTOP;
                            break;
                        case 2:
                            descripcion = "Smartphone";
                            precioUnitario = PRECIO_SMARTPHONE;
                            porcentajeIvaProducto = IVA_SMARTPHONE;
                            break;
                        case 3:
                            descripcion = "Tablet";
                            precioUnitario = PRECIO_TABLET;
                            porcentajeIvaProducto = IVA_TABLET;
                            break;
                        case 4:
                            descripcion = "Monitor";
                            precioUnitario = PRECIO_MONITOR;
                            porcentajeIvaProducto = IVA_MONITOR;
                            break;
                        case 5:
                            descripcion = "Teclado y Mouse (Combo)";
                            precioUnitario = PRECIO_COMBO;
                            porcentajeIvaProducto = IVA_COMBO;
                            break;
                        case 6:
                            descripcion = "Disco SSD 1TB";
                            precioUnitario = PRECIO_DISCO;
                            porcentajeIvaProducto = IVA_DISCO;
                            break;
                        case 7:
                            descripcion = "Licencia de Software";
                            precioUnitario = PRECIO_LICENCIA;
                            porcentajeIvaProducto = IVA_LICENCIA;
                            break;
                    }

                    double valorBrutoProducto = precioUnitario * cantidad;
                    double ivaProducto = valorBrutoProducto * porcentajeIvaProducto;

                    subtotal += valorBrutoProducto;
                    ivaTotalBruto += ivaProducto;

                    switch (codigoProducto) {
                        case 1:
                            laptopsVendidas += cantidad;
                            ventasBrutasLaptops += valorBrutoProducto;
                            subtotalLaptopsCliente += valorBrutoProducto;
                            ivaLaptopsCliente += ivaProducto;
                            break;
                        case 2:
                            smartphonesVendidos += cantidad;
                            ventasBrutasSmartphones += valorBrutoProducto;
                            subtotalSmartphonesCliente += valorBrutoProducto;
                            ivaSmartphonesCliente += ivaProducto;
                            break;
                        case 3:
                            tabletsVendidas += cantidad;
                            ventasBrutasTablets += valorBrutoProducto;
                            subtotalTabletsCliente += valorBrutoProducto;
                            ivaTabletsCliente += ivaProducto;
                            break;
                        case 4:
                            monitoresVendidos += cantidad;
                            ventasBrutasMonitores += valorBrutoProducto;
                            subtotalMonitoresCliente += valorBrutoProducto;
                            ivaMonitoresCliente += ivaProducto;
                            break;
                        case 5:
                            combosVendidos += cantidad;
                            ventasBrutasCombos += valorBrutoProducto;
                            subtotalCombosCliente += valorBrutoProducto;
                            ivaCombosCliente += ivaProducto;
                            break;
                        case 6:
                            discosVendidos += cantidad;
                            ventasBrutasDiscos += valorBrutoProducto;
                            subtotalDiscosCliente += valorBrutoProducto;
                            ivaDiscosCliente += ivaProducto;
                            break;
                        case 7:
                            licenciasVendidas += cantidad;
                            ventasBrutasLicencias += valorBrutoProducto;
                            subtotalLicenciasCliente += valorBrutoProducto;
                            ivaLicenciasCliente += ivaProducto;
                            break;
                    }
                    ...
                    cout << yellow << bold << left << setw(12) << codigoProducto << reset
                            ...
                            << "  " << green << "$" << right << setw(12) << fixed << setprecision(0) <<
                            valorBrutoProducto
                            << reset
                    ...
                    cout << "\n" << cyan << bold << "► " << reset << "Desea agregar otro producto? " << italic <<
                            "(s/n): "
                            << reset;
                ...
                cout << cyan << bold << "► " << reset << "Desea participar en un sorteo especial de descuentos? " <<
                        italic
                        << yellow << "(s/n): " << reset;
                cin >> deseaParticipar;
                ...
                if (deseaParticipar == 's' || deseaParticipar == 'S') {
                    ...
                    while (true) {
                        ...
                        cout << "  " << italic << "Lento → suma de cuadrados = " << yellow << bold << sum << reset <<
                                endl;
                        lento = sum;
                ...
                double valorNeto = subtotal - descuento;
                double ivaConDescuento = ivaTotalBruto * (1 - porcentajeDescuento);
                double total = valorNeto + ivaConDescuento;

                totalVentasNetas += valorNeto;

                double descuentoLaptopsCliente = subtotalLaptopsCliente * porcentajeDescuento;
                double descuentoSmartphonesCliente = subtotalSmartphonesCliente * porcentajeDescuento;
                double descuentoTabletsCliente = subtotalTabletsCliente * porcentajeDescuento;
                double descuentoMonitoresCliente = subtotalMonitoresCliente * porcentajeDescuento;
                double descuentoCombosCliente = subtotalCombosCliente * porcentajeDescuento;
                double descuentoDiscosCliente = subtotalDiscosCliente * porcentajeDescuento;
                double descuentoLicenciasCliente = subtotalLicenciasCliente * porcentajeDescuento;

                descuentosLaptops += descuentoLaptopsCliente;
                descuentosSmartphones += descuentoSmartphonesCliente;
                descuentosTablets += descuentoTabletsCliente;
                descuentosMonitores += descuentoMonitoresCliente;
                descuentosCombos += descuentoCombosCliente;
                descuentosDiscos += descuentoDiscosCliente;
                descuentosLicencias += descuentoLicenciasCliente;

                ivaLaptops += ivaLaptopsCliente * (1 - porcentajeDescuento);
                ivaSmartphones += ivaSmartphonesCliente * (1 - porcentajeDescuento);
                ivaTablets += ivaTabletsCliente * (1 - porcentajeDescuento);
                ivaMonitores += ivaMonitoresCliente * (1 - porcentajeDescuento);
                ivaCombos += ivaCombosCliente * (1 - porcentajeDescuento);
                ivaDiscos += ivaDiscosCliente * (1 - porcentajeDescuento);
                ivaLicencias += ivaLicenciasCliente * (1 - porcentajeDescuento);

                montoTotalLaptops += (subtotalLaptopsCliente - descuentoLaptopsCliente) +
                        ivaLaptopsCliente * (1 - porcentajeDescuento);
                montoTotalSmartphones += (subtotalSmartphonesCliente - descuentoSmartphonesCliente) +
                        ivaSmartphonesCliente * (1 - porcentajeDescuento);
                montoTotalTablets += (subtotalTabletsCliente - descuentoTabletsCliente) +
                        ivaTabletsCliente * (1 - porcentajeDescuento);
                montoTotalMonitores += (subtotalMonitoresCliente - descuentoMonitoresCliente) +
                        ivaMonitoresCliente * (1 - porcentajeDescuento);
                montoTotalCombos += (subtotalCombosCliente - descuentoCombosCliente) +
                        ivaCombosCliente * (1 - porcentajeDescuento);
                montoTotalDiscos += (subtotalDiscosCliente - descuentoDiscosCliente) +
                        ivaDiscosCliente * (1 - porcentajeDescuento);
                montoTotalLicencias += (subtotalLicenciasCliente - descuentoLicenciasCliente) +
                ...
                cout << bold << cyan << left << setw(18) << "Cliente:" << reset << green << nombreCliente << reset <<
                        endl;
